...
class DM_DRIVER(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    channel_count = property(_bmc.DM_DRIVER_channel_count_get, _bmc.DM_DRIVER_channel_count_set, doc=r"""channel_count : unsigned int""")
    serial_number = property(_bmc.DM_DRIVER_serial_number_get, _bmc.DM_DRIVER_serial_number_set, doc=r"""serial_number : a(11+1).char""")
    reserved = property(_bmc.DM_DRIVER_reserved_get, _bmc.DM_DRIVER_reserved_set, doc=r"""reserved : a(7).unsigned int""")
    ...
    def __init__(self):
        ...
        """
        _bmc.DM_DRIVER_swiginit(self, _bmc.new_DM_DRIVER())
    __swig_destroy__ = _bmc.delete_DM_DRIVER

# Register DM_DRIVER in _bmc:
_bmc.DM_DRIVER_swigregister(DM_DRIVER)
...
class DM(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    Driver_Type = property(_bmc.DM_Driver_Type_get, _bmc.DM_Driver_Type_set, doc=r"""Driver_Type : unsigned int""")
    DevId = property(_bmc.DM_DevId_get, _bmc.DM_DevId_set, doc=r"""DevId : unsigned int""")
    HVA_Type = property(_bmc.DM_HVA_Type_get, _bmc.DM_HVA_Type_set, doc=r"""HVA_Type : unsigned int""")
    use_fiber = property(_bmc.DM_use_fiber_get, _bmc.DM_use_fiber_set, doc=r"""use_fiber : unsigned int""")
    use_CL = property(_bmc.DM_use_CL_get, _bmc.DM_use_CL_set, doc=r"""use_CL : unsigned int""")
    burst_mode = property(_bmc.DM_burst_mode_get, _bmc.DM_burst_mode_set, doc=r"""burst_mode : unsigned int""")
    fiber_mode = property(_bmc.DM_fiber_mode_get, _bmc.DM_fiber_mode_set, doc=r"""fiber_mode : unsigned int""")
    ActCount = property(_bmc.DM_ActCount_get, _bmc.DM_ActCount_set, doc=r"""ActCount : unsigned int""")
    MaxVoltage = property(_bmc.DM_MaxVoltage_get, _bmc.DM_MaxVoltage_set, doc=r"""MaxVoltage : unsigned int""")
    VoltageLimit = property(_bmc.DM_VoltageLimit_get, _bmc.DM_VoltageLimit_set, doc=r"""VoltageLimit : unsigned int""")
    mapping = property(_bmc.DM_mapping_get, _bmc.DM_mapping_set, doc=r"""mapping : a(260).char""")
    inactive = property(_bmc.DM_inactive_get, _bmc.DM_inactive_set, doc=r"""inactive : a(4096).unsigned int""")
    profiles_path = property(_bmc.DM_profiles_path_get, _bmc.DM_profiles_path_set, doc=r"""profiles_path : a(260).char""")
    maps_path = property(_bmc.DM_maps_path_get, _bmc.DM_maps_path_set, doc=r"""maps_path : a(260).char""")
    cals_path = property(_bmc.DM_cals_path_get, _bmc.DM_cals_path_set, doc=r"""cals_path : a(260).char""")
    cal = property(_bmc.DM_cal_get, _bmc.DM_cal_set, doc=r"""cal : a(260).char""")
    serial_number = property(_bmc.DM_serial_number_get, _bmc.DM_serial_number_set, doc=r"""serial_number : a(11+1).char""")
    driver = property(_bmc.DM_driver_get, _bmc.DM_driver_set, doc=r"""driver : DM_DRIVER""")
    priv = property(_bmc.DM_priv_get, _bmc.DM_priv_set, doc=r"""priv : p.DM_PRIV""")
    ActCountWidth = property(_bmc.DM_ActCountWidth_get, _bmc.DM_ActCountWidth_set, doc=r"""ActCountWidth : unsigned int""")
    ActLayout = property(_bmc.DM_ActLayout_get, _bmc.DM_ActLayout_set, doc=r"""ActLayout : DMLayout""")
    reserved = property(_bmc.DM_reserved_get, _bmc.DM_reserved_set, doc=r"""reserved : a(8).unsigned int""")
    ...
    def __init__(self):
        ...
        """
        _bmc.DM_swiginit(self, _bmc.new_DM())
    __swig_destroy__ = _bmc.delete_DM

# Register DM in _bmc:
_bmc.DM_swigregister(DM)
